...
const AcceptsAndRejectsTardinessGroup = ({ Modal, Button, handleCloseAccepts, openAcceptsAndRejects, seletedDetails, ItemContentModal, handleCloseCancel, openRejects, WarningRoundedIcon, onSubmit, setObservacion_1, Observacion_1 }) => {
    return (
        <>
...
export default AcceptsAndRejectsTardinessGroup