...
import { ItemContent, ItemContentModal, CustomNoRowsOverlay, CustomPagination, StyledDataGrid, PAGE_SIZE } from '../../Styles/Styles';
...
import AcceptsAndRejectsTardinessWFM from './AcceptsAndRejects/AcceptsAndRejectsTardinessWFM';
import DetailsTardinessWFM from './DetailsTardinessWFM/DetailsTardinessWFM';
...
const TardinessWFM = () => {
    ...
    const onSubmit = async (Estado) => {
        ...
        if (fullName && seletedDetails && Estado_Marcado_Aprobador_1) {
            ...
            await apiClient.put(`http://${Servidor}/API/REJECTSORACCEPTS/TARDINESS/WFM/${seletedDetails.Id}`, { Aprobador_1, Documento_1, Estado_Marcado_Aprobador_1, Observacion_1 });
            fetchData();
            clearCells();
            handleCloseCancel();
            handleCloseAccepts();
        ...
        <>
            ...
            <ItemContent className='mb-4'>
                <div className='text-center'>
                    <div className='mb-0 title-metas'>Solicitudes WFM</div>
                </div>
            </ItemContent>
