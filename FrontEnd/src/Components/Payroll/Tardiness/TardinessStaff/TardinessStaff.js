...
import ReportsTardinessStaff from '../ReportsTardinesStaff/ReportsTardinesStaff';
...
const TardinessStaff = () => {
    ...
    const onSubmit = () => {
        apiClient.post(`http://${Servidor}/API/SAVE/TARDINESS-REQUEST/STAFF`, {
            dateTardiness,
            dateTardinessTwo,
            Documento,
            Usuario_Red,
