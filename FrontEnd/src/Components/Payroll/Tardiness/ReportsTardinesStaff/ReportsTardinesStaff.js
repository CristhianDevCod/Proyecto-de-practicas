                    ...
                    <div className='row align-items-center'>
                        <div className='col mb-3'>
                            ...
                            <select disabled={!selectTypeTardiness} value={typeTardiness} onChange={handleTypeTardiness} className='form-select' id='tipoSolicitud' name='Tipo_Solicitud' >
                                ...
                                {Array.isArray(listTardiness) &&
                                    listTardiness.filter(item =>
                                        item.Name_Tardiness !== 'FORMACION' &&
                                        item.Name_Tardiness !== 'FORMACION NESTING' &&
                                        item.Name_Tardiness !== 'LLAMADA LARGA' &&
                                        item.Name_Tardiness !== 'NO HAY PUESTOS')
...
export default ReportsTardinessStaff;