...
const AcceptsAndRejectsTardinessNomina = ({ Modal, Button, handleCloseAccepts, openAcceptsAndRejects, seletedDetails, ItemContentModal, handleCloseCancel, openRejects, WarningRoundedIcon, onSubmit, setObservacion_1, Observacion_2 }) => {
    return (
        <>
...
export default AcceptsAndRejectsTardinessNomina