...
export default function OperacionForm({ clienteId, clienteNombre, initialDataOpe, onClose, onOperacionSaved, idNewOperacionClienteFormPopPup, fetchOperaciones }) {
  ...
  const [skillData, setSkillData] = useState({
    ...
    estado: '',
    servicioId: null,
    skills: [{ nombreSkill: '', idSistemaGestion: '', fechaInicio: null, fechaFin: null, estadoSkill: 'activo', error: null }]
  });
    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} md={8}>
        ...
        {step === 2 && <OperacionInicialForm
          ...
          idNewOperacionClienteFormPopPup={idNewOperacionClienteFormPopPup}
          onClose={onClose} />}
        {/* Formulario Segmento */}
        {step === 3 && <SegmentoForm
          operacionId={operacionData.id}
        ...
        {canalAtencionId === "Outbound" || canalAtencionId === "OUTBOUND" || canalAtencionId === "outbound" ? (
          ...
          step === 6 && <FinOperacionPage
            handleBack={handleBackClosed}
          />
        )}
      </Grid>
    </Grid>
