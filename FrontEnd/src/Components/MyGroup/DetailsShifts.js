...
const DetailsShifts = ({ isModalOpen, selectedShift, handleModalClose }) => {
    return (
        <>
            <>
                <Modal
                ...
                >
                    <div>
                        ...
                        {/* VERDES */}
                        {selectedShift && selectedShift.Novedad === 'TUR' && (
                            <>
                                <Box className='modal-day-TUR'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Novedad}</div>
                                                <div id='name-shifts'>Novedad</div>
                                            </div>
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Horas_Laboradas}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Turno_Ini}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Des_1_Ini} - {selectedShift.Des_1_Fin}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Des_2_Ini} - {selectedShift.Des_2_Fin}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Des_3_Ini} - {selectedShift.Des_3_Fin}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Lunch_Ini} - {selectedShift.Lunch_Fin}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Dialogo_Ini} - {selectedShift.Dialogo_Fin}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Training_1_Ini} - {selectedShift.Training_1_Fin}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Training_2_Ini} - {selectedShift.Training_2_Ini}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Lac_Ini} - {selectedShift.Lac_Fin}</div>
                                        ...
                                        <div className='content-data-nov'>
                                            ...
                                            <div className='content-data-info'>
                                                <div className='text-muted'>{selectedShift.Turno_Fin}</div>
                        ...
                        {/* AZUL 1 */}
                        {selectedShift && selectedShift.Novedad === 'DES' && (
                            <>
                        ...
                        {/* ROJOS */}
                        {selectedShift && selectedShift.Novedad === 'SUS' && (
                            <>
                        ...
                        {selectedShift && selectedShift.Novedad === 'PAB' && (
                            <>
                                <Box className='modal-day-sus'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {selectedShift && selectedShift.Novedad === 'SC' && (
                            <>
                                <Box className='modal-day-sus'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {selectedShift && selectedShift.Novedad === 'RET' && (
                            <>
                                <Box className='modal-day-sus'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {/* MORADOS */}
                        {selectedShift && selectedShift.Novedad === 'LPA' && (
                            <>
                        ...
                        {selectedShift && selectedShift.Novedad === 'LMA' && (
                            <>
                                <Box className='modal-day-LR-LPA-DPAG-LMA'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {selectedShift && selectedShift.Novedad === 'DPAG' && (
                            <>
                                <Box className='modal-day-LR-LPA-DPAG-LMA'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {selectedShift && selectedShift.Novedad === 'LR' && (
                            <>
                                <Box className='modal-day-LR-LPA-DPAG-LMA'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {selectedShift && selectedShift.Novedad === 'VAC' && (
                            <>
                                <Box className='modal-day-LR-LPA-DPAG-LMA'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {selectedShift && selectedShift.Novedad === 'JVOT' && (
                            <>
                                <Box className='modal-day-LR-LPA-DPAG-LMA'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {selectedShift && selectedShift.Novedad === 'LDF' && (
                            <>
                                <Box className='modal-day-LR-LPA-DPAG-LMA'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {/* NARANJA */}
                        {selectedShift && selectedShift.Novedad === 'ICCP' && (
                            <>
                        ...
                        {selectedShift && selectedShift.Novedad === 'LNR' && (
                            <>
                                <Box className='modal-day-ICCP-LNR'>
                                    <div className='content-data'>
                                        <div className='content-data-nov'>
                        ...
                        {/* AZUL2 */}
                        {selectedShift && selectedShift.Novedad === 'FOR' && (
                            <>
                        ...
                        {/* AZUL3 */}
                        {selectedShift && selectedShift.Novedad === 'SOP' && (
                            <>
                        ...
                        {/* SALMON */}
                        {selectedShift && selectedShift.Novedad === 'VOT' && (
                            <>
