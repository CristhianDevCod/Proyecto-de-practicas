...
const AcceptsAndRejectManager = ({ Modal, openModalOpenAndAccepts, handleCloseModalAcceptsAndRejectAccepts, WarningRoundedIcon, handleCloseModalAcceptsAndRejectReject, Button, handleObservacion, observacion, handleRejectNotificationNoveltie, handleAcceptNotificationNovelties, openModalOpenAndRejects }) => {
    return (
        <>
            <Modal
                title={
                    <div className='mb-3 d-flex'>
                        ...
                        <div className='p-2'>
                            <p className='lead'>¿Deseas aceptar esta novedad?</p>
                        </div>
                    </div>
                }
                footer={null}
...
export default AcceptsAndRejectManager;