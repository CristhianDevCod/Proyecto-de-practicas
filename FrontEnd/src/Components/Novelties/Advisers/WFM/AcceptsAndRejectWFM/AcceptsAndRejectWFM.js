...
const AcceptsAndRejectWFM = ({
    Modal,
    Button,
    observacion,
    handleObservacion,
    WarningRoundedIcon,
    openModalOpenAndRejects,
    openModalOpenAndAccepts,
    handleRejectNotificationNoveltie,
    handleAcceptNotificationNovelties,
...
export default AcceptsAndRejectWFM;