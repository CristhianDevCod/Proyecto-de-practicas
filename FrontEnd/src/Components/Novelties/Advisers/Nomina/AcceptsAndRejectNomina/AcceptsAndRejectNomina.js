...
const AcceptsAndRejectNomina = ({ Modal, openModalOpenAndAccepts, handleCloseModalAcceptsAndRejectAccepts, WarningRoundedIcon, handleCloseModalAcceptsAndRejectReject, Button, handleObservacion, observacion, handleRejectNotificationNoveltie, handleAcceptNotificationNovelties, openModalOpenAndRejects }) => {
    return (
        <>
            <Modal
                title={
...
export default AcceptsAndRejectNomina;