...
const GenerateRequest = ({ Modal, open, hanldeCloseModal, listNovelties, minDate, formDataNovelties, handleformDataNovelties, sendRequest, daysBetween, maxDate, validErrors, Button, }) => {
    ...
    const renderTimeMoney = () => {
        ...
        if (formDataNovelties.Tipo_Solicitud === 'VAC' && formDataNovelties.Time_Money === 'SI' && formDataNovelties.How_Long && formDataNovelties.Motivo) {
        ...
        else if (formDataNovelties.Tipo_Solicitud === 'LR' && formDataNovelties.Motivo) {
            return false;
        } else if (formDataNovelties.Tipo_Solicitud === 'LR' && !formDataNovelties.Motivo) {
            return true;
        }
            ...
            return false;
        } else if (formDataNovelties.Tipo_Solicitud === 'LDF' && !formDataNovelties.Motivo) {
            return true;
        } else if (formDataNovelties.Tipo_Solicitud === 'LDF' && formDataNovelties.Motivo) {
            return false;
        } else if (formDataNovelties.Tipo_Solicitud === 'DPAG' && !formDataNovelties.Motivo) {
                    ...
                    <div className='row aling-items-center'>
                        ...
                        <div className='col mb-3'>
                            <label htmlFor='Name_Diag' className='form-label'>
                                Nombre del Diagnostico<div id='invalid-feedback'>*</div>
                            </label>
    ...
    const renderConditionsInputsEntryLPAICCPLMA = (formDataNovelties) => {
        if (formDataNovelties.Tipo_Solicitud === 'LPA' && formDataNovelties.Number_Iccp && formDataNovelties.Number_Diag && formDataNovelties.Name_Diag) {
            return false;
        } else if (formDataNovelties.Tipo_Solicitud === 'LPA' && !formDataNovelties.Number_Iccp && !formDataNovelties.Number_Diag && !formDataNovelties.Name_Diag) {
            return true;
        } else if (formDataNovelties.Tipo_Solicitud === 'LPA' && formDataNovelties.Number_Iccp && !formDataNovelties.Number_Diag && !formDataNovelties.Name_Diag) {
            return true;
        } else if (formDataNovelties.Tipo_Solicitud === 'LPA' && formDataNovelties.Number_Iccp && formDataNovelties.Number_Diag && !formDataNovelties.Name_Diag) {
        ...
        >
            <div className='container mt-5' >
                <div>
                    ...
                    {formDataNovelties.Tipo_Solicitud === 'VOT' || formDataNovelties.Tipo_Solicitud === 'LUT' || formDataNovelties.Tipo_Solicitud === 'JVOT' || formDataNovelties.Tipo_Solicitud === 'LMA' || formDataNovelties.Tipo_Solicitud === 'LPA' || formDataNovelties.Tipo_Solicitud === 'LLT' || formDataNovelties.Tipo_Solicitud === 'AISL' ? (
                    ...
                    <div className='mb-3'>
                        <label htmlFor='motivo' className='form-label d-flex'>
                            Comentario {formDataNovelties.Tipo_Solicitud === 'VAC' || formDataNovelties.Tipo_Solicitud === 'LNR' || formDataNovelties.Tipo_Solicitud === 'PDA ME' || formDataNovelties.Tipo_Solicitud === 'DPAG' || formDataNovelties.Tipo_Solicitud === 'LDF' || formDataNovelties.Tipo_Solicitud === 'LR' ? (<div id='invalid-feedback' className='p-1'>(Obligatorio, VAC, LNR, PDA ME, DPAG, LDF)</div>) : ('')}
                        </label>
                        <textarea
                            id='motivo'
                            name='Motivo'
                    ...
                    <div className='d-flex flex-row-reverse'>
                        ...
                        <div className='p-2'>
                            <Button variant='soft' disabled={
                                ...
                                renderTimeMoney() ||
                                renderConditionsInputsEntryLPAICCPLMA(formDataNovelties)
