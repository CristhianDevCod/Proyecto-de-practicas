...
import Header from '../../Advisers/Header/Header';
...
//HOOKS
import { NoveltiesPending, NoveltiesAccepts, NoveltiesRejects } from '../../Advisers/Hooks/Hooks';
...
const Noveltie = () => {
    ...
    //MKANDAMOS LA SOLICITUD Y LINPIAMOS LOS ESTADOS 
    const sendRequest = () => {
