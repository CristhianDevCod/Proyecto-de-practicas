...
import { PERMISSIONSCLIENTSNOMINA, User_Permissions, getAllListClient } from '../../API/API';
import Service from '../../Machine/Service';
import apiClient from '../../Service/Service';

const AddClientPermissionsNomina = () => {
    ...
    const getUserPermissions = async (usuarioRed) => {
        ...
        try {
            const response = await PERMISSIONSCLIENTSNOMINA(usuarioRed);
    ...
    const savePermissions = async () => {
        try {
            ...
            if (action === 'delete') {
                ...
                const response = await apiClient.put(`http://${Servidor}/API/INSERT-PERMISSIONS-CLIENT/PUT/NOMINA/`, {
                    action: action,
    ...
    return (
        <>
            ...
            <div className='text-center'>
                <div className='mb-0 title-import'>Permisos de clientes nomina</div>
            </div>
...
export default AddClientPermissionsNomina;
